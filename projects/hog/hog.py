...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if not player:
            ...
            tmp = take_turn(num_rolls, score1, dice)         
            score0 += tmp
        else:
            num_rolls = strategy1(score1, score0)
            tmp = take_turn(num_rolls, score0, dice)
            score1 += tmp
        ...
        player = not player
        if player:
            tmp_func = say(score0, score1)
        else:
            tmp_func = tmp_func(score0,score1)
    "*** YOUR CODE HERE ***"
    # END PROBLEM 5
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    tmp = free_bacon(opponent_score)
    check_benifit = is_swap(score+tmp, opponent_score) and (score+tmp)<opponent_score
    if tmp >= margin or check_benifit:
        return 0
    return num_rolls  # Replace this statement
    # END PROBLEM 11
